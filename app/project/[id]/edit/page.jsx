...
async function getData(projectId) {
  try {
    ...
    const { data: p } = await supabase
      .from("projects")
      .select("id, owner_id, name, description, photo_url, type, skills_needed, interests, min_size, max_size, timeline_start, timeline_end, privacy, joining_method, project_link, resource_files, course_code, instructor, things_to_note")
      .eq("id", projectId)
      .single();
